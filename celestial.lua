...
function Library:create(options)
	...
	creditsTab:credit{Name = "Moons", Description = "UI Library Developer", Discord = "Moons#9999", V3rmillion = "Moozy"}
